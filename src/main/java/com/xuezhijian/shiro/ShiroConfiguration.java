...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
      ...
      //  filterChainDefinitionMap.put("/getBarrager", "anon");
        filterChainDefinitionMap.put("/signin", "anon");
        filterChainDefinitionMap.put("/upLoadPicture", "anon");
...
//        filterChainDefinitionMap.put("/configprops", "roles[aix]");
        ...
        filterChainDefinitionMap.put("/**.png", "anon");//图片验证码(kaptcha框架)
        ...
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl("/main/index3");
        // 未授权界面
